...
namespace MMOR.NET.Random {
  ...
  ///     <br /> - <b>19937</b> indicates the length. Meaning the RNG will exhaust its randomness in
  ///     2 ^ 19937 - 1 iterations. <br /> - Automatically reseed when range is exhausted. <br /> -
  ///     Implements generic abstract class with other rng for interchangibility. <br />
  ///     -+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  /// </summary>
