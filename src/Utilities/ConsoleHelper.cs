...
namespace MMOR.Utils.Utilities
{
    public static partial class Utilities
    {
        ...
        /// <returns></returns>
        public static T ConsoleSafeRead<T>(TryParseDelegate<T> parseFunc, Func<T, bool>? predicate = null)
        {
            predicate ??= _ => true;
            while (true)
        ...
        ///     <br /> -+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-
        /// </summary>
        public static T ConsoleSafeRead<T>(out T result, Func<T, bool>? predicate = null) where T : struct, Enum
        {
            predicate ??= _ => true;
            int max = MaxFlag<T>();
            while (true)
