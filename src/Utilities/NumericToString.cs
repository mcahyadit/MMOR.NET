  ...
  public static partial class Utilities
  {
      ...
      where T : struct, IComparable, IConvertible, IFormattable
    {
      ...
      if (value > TimeSpan.MaxValue.TotalSeconds || value < TimeSpan.MinValue.TotalSeconds)
        return $"TimeSpan Overflow protection, DEBUG - Recorded seconds: {value}, which is over {TimeSpan.MaxValue.TotalSeconds}";
    ...
    public static List<double> parseAny(this string strIn)
    {
      ...
      foreach (string str in strIn.parseAnyRaw())
      {
        ...
        if (string.IsNullOrEmpty(str))
          ...
          numericValues.Add(
            double.Parse(str.Substring(0, str.Length - 1), numStyle)
    ...
    public static string BoxPlotRepresentation(
      double Q1,
      double Q2,
      double Q3,
      Func<double, string> stringFormat,
