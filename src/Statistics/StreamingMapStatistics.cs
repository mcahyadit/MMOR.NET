...
namespace MMOR.NET.Statistics
{
  ...
  public static class StreamingMapStatistics
  {
    ...
    public static double Mean<T>(this IEnumerable<(T, uint)> map)
    ...
    public static double Variance<T>(this IEnumerable<(T, uint)> map, bool sample = true)
      where T : IConvertible
    {
    ...
    public static double GeometricMean<T>(this IEnumerable<(T, uint)> map)
      where T : IConvertible
    {
    ...
    public static double HarmonicMean<T>(this IEnumerable<(T, uint)> map)
      where T : IConvertible
    {
    ...
    public static double RootMeanSquare<T>(this IEnumerable<(T, uint)> map)
      where T : IConvertible
    {
    ...
    public static double GiniCoefficient<T>(this IEnumerable<(T, uint)> map)
      where T : IConvertible
    {
    ...
    public static double Entropy<T>(this IEnumerable<(T, uint)> map)
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="Mean" />
    public static double Mean<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    public static double Variance<T>(
      this IEnumerable<KeyValuePair<T, uint>> map,
      bool sample = true
    )
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="StandardError" />
    public static double StandardError<T>(
      this IEnumerable<KeyValuePair<T, uint>> map,
      bool sample = true
    )
      where T : IConvertible
    ...
    /// <inheritdoc cref="GeometricMean" />
    public static double GeometricMean<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="HarmonicMean" />
    public static double HarmonicMean<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="RootMeanSquare" />
    public static double RootMeanSquare<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="GiniCoefficient" />
    public static double GiniCoefficient<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    /// <inheritdoc cref="Entropy" />
    public static double Entropy<T>(this IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
    ...
    private static (double variance, ulong count) VarBaseAlgo(
      this IEnumerable<(double, uint)> map,
      bool sample = true
    )
    {
      double variance = 0;
