...
namespace MMOR.NET.Statistics
{
  ...
  public class TotalStatistics
  {
    ...
    {
      IOrderedEnumerable<KeyValuePair<double, ulong>> _oMap = FirstPassLoopList(list)
        .OrderBy(x => x.Key);
      SecondPassLoop(_oMap);
      ThirdPassLoop(_oMap);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TotalStatistics Calculate(IEnumerable<KeyValuePair<double, ulong>> map) =>
      new(map);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TotalStatistics Calculate<T>(IEnumerable<KeyValuePair<T, uint>> map)
      where T : IConvertible
    {
      return new TotalStatistics(
        map.Select(x => new KeyValuePair<double, ulong>(x.Key.ToDouble(null), x.Value))
      );
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TotalStatistics Calculate<T>(IEnumerable<KeyValuePair<T, ulong>> map)
      where T : IConvertible
    {
      return new TotalStatistics(
        map.Select(x => new KeyValuePair<double, ulong>(x.Key.ToDouble(null), x.Value))
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TotalStatistics Calculate<T>(IEnumerable<T> list)
      where T : IConvertible
    {
    ...
    protected virtual IEnumerable<KeyValuePair<double, ulong>> FirstPassLoopList(
