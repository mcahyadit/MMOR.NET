...
namespace MMOR.NET.Statistics
{
  ...
  public static class StreamingStatistics
  {
    ...
    public static double Mean<T>(this IEnumerable<T> stream)
    ...
    public static double Variance<T>(this IEnumerable<T> stream, bool sample = true)
      where T : IConvertible
    {
    ...
    public static double StandardDeviation<T>(this IEnumerable<T> stream, bool sample = true)
      where T : IConvertible
    {
    ...
    public static double StandardError<T>(this IEnumerable<T> stream, bool sample = true)
      where T : IConvertible
    {
    ...
    public static double Covariance<T>(
      IEnumerable<T> streamX,
      IEnumerable<T> streamY,
      bool sample = true
    )
      where T : IConvertible
    {
      return Covariance(
        streamX.Select(x => x.ToDouble(null)),
        streamY.Select(x => x.ToDouble(null)),
        sample
      );
    }

    /// <inheritdoc cref="GeometricMean" />
    public static double GeometricMean<T>(this IEnumerable<T> stream)
      where T : IConvertible
    {
    ...
    public static double HarmonicMean<T>(this IEnumerable<T> stream)
      where T : IConvertible
    {
    ...
    public static double RootMeanSquare<T>(this IEnumerable<T> stream)
      where T : IConvertible
    {
    ...
    public static double GiniCoefficient<T>(this IEnumerable<T> stream)
      where T : IConvertible
    {
    ...
    public static (double variance, ulong count) VarBaseAlgo(
      this IEnumerable<double> stream,
      bool sample = true
    )
    {
      double variance = 0;
    ...
    public static double Covariance(
      IEnumerable<double> streamX,
      IEnumerable<double> streamY,
      bool sample = true
    )
    {
      var count = 0;
