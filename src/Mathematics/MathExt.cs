...
namespace MMOR.NET.Mathematics
{
  ...
  public static partial class MathExt
  {
    ...
    public static int Repeat(this int value, int length) =>
      Math.Clamp(value - value / length * length, 0, length);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 Lerp(in Vector4 a, in Vector4 b, float alpha) =>
      Vector4.Lerp(a, b, alpha);
