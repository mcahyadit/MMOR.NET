...
public class RichStringFontWeight : IRecursiveRichString {
  ...
  public RichStringFontWeight(IRichString str,
...
public static partial class RichStringUtils {
  public static RichStringFontWeight SetWeight(this string text,
      RichFontWeight font_weight) => new((RichStringPlain)text, font_weight);

  public static RichStringFontWeight SetWeight<T>(this string text,
      T font_weight) where T : struct, IConvertible =>
      new((RichStringPlain)text, font_weight.ToUInt32(null));

  public static RichStringFontWeight SetWeight(this IRichString text,
      RichFontWeight font_weight) => new(text.Clone(), font_weight);

  public static RichStringFontWeight SetWeight<T>(this IRichString text,
      T font_weight) where T : struct, IConvertible =>
      new(text.Clone(), font_weight.ToUInt32(null));
}
}