...
public struct RichStringColor {
  ...
  public RichStringColor(float red, float green, float blue,
      float alpha = 1.0f) {
    R = (byte)(red * 255);
    G = (byte)(green * 255);
    B = (byte)(blue * 255);
  ...
  public static implicit operator RichStringColor(Vector4 vector) => new(vector.X, vector.Y, vector.Z, vector.W);
  public static implicit operator RichStringColor(Vector3 vector) => new(vector.X, vector.Y, vector.Z);
}
...
public class RichStringColored : IRecursiveRichString {
  ...
  public RichStringColored(IRichString str, byte red, byte green, byte blue,
      byte alpha = 0xFF) {
    this.str = str;
    color    = new RichStringColor(red, green, blue, alpha);
  }

  public RichStringColored(IRichString str, float red, float green, float blue,
      float alpha = 1.0f) {
    this.str = str;
    color    = new RichStringColor(red, green, blue, alpha);
  }
...
public static partial class RichStringUtils {
  public static RichStringColored SetColor(this string text,
      RichStringColor color) =>
      new((RichStringPlain)text, color);
  public static RichStringColored SetColor(this IRichString text,
      RichStringColor color) =>
