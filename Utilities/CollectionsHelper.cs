...
namespace MMOR.NET.Utilities
{
  ...
  public static partial class Utilities
  {
    ...
    public static List<int> toIndicesList(
      this IReadOnlyList<bool> boolList,
    ...
    public static void Upsert<TKey, TValue>(
      this IDictionary<TKey, TValue> list,
      TKey index,
      TValue val
    )
      where TKey : struct
    ...
    public static TValue GetCastedValueOrDefault<TKey, TValue>(
      ...
      TKey key,
      Func<object, TValue> castDefinition,
    ...
    public static string GetCastedValueOrDefault<TKey>(
      ...
      TKey key,
      string defaultValue = ""
    ) => GetCastedValueOrDefault(dictionary, key, x => x as string ?? defaultValue, defaultValue);
